    ...
    <section id='products' className='py-16 bg-gradient-to-b from-syntara-dark to-syntara-darker'>
      <div className='section-container'>
        <div className='text-center mb-12'>
          <h2 className='text-2xl md:text-3xl font-bold mb-4 text-white'>Product Categories</h2>
          <p className='text-syntara-light/80 max-w-2xl mx-auto'>Entry Point to Products</p>
        </div>
